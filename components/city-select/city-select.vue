	...
	<view class="city-select">
		<scroll-view :scroll-top="scrollTop" scroll-y="true" class="city-select-main" id="city-select-main" :scroll-into-view="toView">
			...
			<view class="hot-city" v-if="activeCity && !serachCity">
				...
				<view class="hot-item" @tap="getCity">
					<text class="lg text-gray cuIcon-location" style="color: red;"></text>
					<text style="color: red;">重新定位</text>
				</view>
			</view>
			<!-- 热门城市 -->
					...
					success: (res) => {
						...
						uni.request({
							...
							success: res => {
								...
								this.$emit('childCity', res.data.result.ad_info.city);
								uni.showToast({
